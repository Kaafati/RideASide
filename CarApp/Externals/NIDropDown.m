...
- (id)showDropDown:(UIButton *)b :(CGFloat *) height :(NSArray *)arr :(NSArray *)imgArr :(NSString *)direction :(UITableView *)toSubtableview {
    ...
    if (self) {
      ...
      //  [b.superview addSubview:self];
        ...
        [self addSubview:table];
        [toSubtableview addSubview:self];

        //[toSubtableview addSubview:table];
    }
    return self;
}
...
- (void) myDelegate {
   [self.delegate niDropDownDelegateMethod:self selectedIndex:indexPathh];
}
