...
@interface CAIntoPageViewController ()

@end

@implementation CAIntoPageViewController

- (void)viewDidLoad {
    [super viewDidLoad];
     _pageTitles = @[@"Sign in Page", @"Sign-Up Page", @"Your Rides", @"To Create Rides",@"Passenger Rides"];
    _pageImages = @[@"1.jpg", @"2.jpg", @"3.jpg", @"4.jpg",@"5.jpg",@"6.jpg"];
...
- (IBAction)startWalkthrough:(id)sender {
    ...
    CALoginViewController *loginViewController=[self.storyboard instantiateViewControllerWithIdentifier:@"loginView"];
